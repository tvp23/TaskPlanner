...
class CompletedTasksController extends Controller
{
    ...
    public function index()
    {
        ...
        $tasks = DB::table('tasks')
            ...
            ->get();
        return view('tasks.completed.index', compact('tasks', 'user'));
    }
    ...
    {
        return view('tasks.completed.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('tasks.completed.show', compact('task'));
    }
    ...
    {
        $task = task::find($id);
        return view('tasks.completed.edit', compact('task'));
    }
