...
class On_holdTasksController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $tasks = DB::table('tasks')
            ...
            ->get();
        return view('tasks.on_hold.index', compact('tasks', 'user'));
    }
    ...
    {
        return view('tasks.on_hold.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('tasks.on_hold.show', compact('task'));
    }
    ...
    {
        $task = task::find($id);
        return view('tasks.on_hold.edit', compact('task'));
    }
